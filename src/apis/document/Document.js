...
async function getTempDocumentList(query, column, order, page) {
    try {
        const params = {
            query: query,
            column: column,
...
const DocumentAPI = {
    getDocumentList, getTempDocumentList, getDocument, createTempDocument, createDocument, extractDocument
}
